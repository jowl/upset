...
module Upset
  describe self do
    ...
    let :default_provider do
      Provider::Simple.new(default_properties)
    end
    ...
    describe Configuration do
      before do
        configuration.providers << Provider::Simple.new('beta' => 43)
      end
      ...
      context 'when merging different Providers' do
        before do
          configuration.providers << Provider::Simple.new('gamma' => {'a' => {'A' => 1, 'B' => 2}})
          configuration.providers << Provider::Simple.new('gamma' => {'a' => {'B' => 3, 'C' => 4}, 'b' => {}})
        end
